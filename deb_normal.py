# debian_lts_normal.py (Final Production Version)
import os
import logging
import re
import sys
...
logger = logging.getLogger("debian_lts_normalizer")
load_dotenv()
        ...
        with psycopg2.connect(**DB_CONFIG) as conn:
            with conn.cursor() as cur:
                ...
                for staging_id, raw_data in rows:
                    ...
                    recommendation = " ".join([f"For '{fix['distribution']}', upgrade to version {fix['version']}." for fix in s_data.get("fixed_in", [])]) or "See advisory URL for details."
...
'''
# debian_lts_normal.py (Production Version)
import os
import logging
import re
import psycopg2
